...
<div class="max-w-screen-md rounded-lg bg-white/50 p-4 shadow-lg backdrop-blur-lg">
	...
	<p class="mb-2">
		...
		wird es auf jeden Fall geben. Auf keinen Fall wollen wir euch dies mit dem Holzhammer
		präsentieren (Tentakelmonster greifen an etc.). Vielmehr werdet ihr feststellen, wie der
		Wahnsinn nach und nach seinen Weg in die zu Beginn friedliche Zusammenkunft bahnt.
	</p>
	<p class="mb-2">
