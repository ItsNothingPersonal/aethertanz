...
<br />
<p>
	<strong class="font-semibold">Vereinsregister:</strong>
	200496
</p>
<p>
	<strong class="font-semibold">Registergericht:</strong>
...
<p>
	<strong class="font-semibold">E-Mail:</strong>
	<a
		class="underline decoration-dotted underline-offset-4"
		href="mailto:Info@NaechtlichesTheater.de"
	>
		Info@NaechtlichesTheater.de
	</a>
</p>
...
<p>
	...
	dem Verein. Jegliche Vervielfältigung ohne vorherige schriftliche Zustimmung ist untersagt.
</p>
